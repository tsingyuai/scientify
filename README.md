...
## 2. 持续积累的优势：受控研究论文已被 ICML 2026 录用

Scientify 采用**持续知识新陈代谢**模式：持续跟进前沿文献，将新知识与已有积累关联，并用实验结果修正假设。知识、假设与实验经验在多轮研究中持续保留，支持后续研究不断深入。

我们在 **50 个研究主题、892 条生成假设**上，对照测试了持续知识新陈代谢与传统批处理范式。新陈代谢模式的假设命中率达到基线的 **1.9 倍**，单主题有效假设数增加 **26%**，单条假设的 Token 成本降低 **92%**。
